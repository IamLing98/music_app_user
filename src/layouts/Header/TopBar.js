...
import TopBarListItem from "../../components/TopBar/TopBarListItem";
          ...
          <div className="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            <ul className="navbar-nav navbar-nav-left">
              <li className="nav-item ml-0 mr-5 d-lg-flex d-none">
                <a href="#" className="nav-link horizontal-nav-left-menu">
            ...
            <ul className="navbar-nav navbar-nav-right">
              ...
              <li className="nav-item dropdown d-lg-flex d-none">
                <a
                  className="dropdown-toggle show-dropdown-arrow btn btn-inverse-primary btn-sm"
                  id="nreportDropdown"
                  href="#"
                  data-toggle="dropdown"
                >
                ...
                >
                  ...
                  <a className="dropdown-item">
                    <i className="mdi mdi-file-pdf text-primary" />
                    Pdf
                  </a>
                  <a className="dropdown-item">
                    <i className="mdi mdi-file-excel text-primary" />
                    Exel
                  </a>
                </div>
              </li>
